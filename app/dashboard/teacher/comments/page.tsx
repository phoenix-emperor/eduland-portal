/**
 * @file app/dashboard/teacher/comments/page.tsx
 * @description Server Component for Teacher General Comment Entry screen (CLASS-TEACHER-ONLY).
 * Fetches classes where current teacher is designated as `classes.class_teacher_id`.
 */
...
export default async function CommentsPage() {
  ...
  // CLASS-TEACHER-ONLY: Strictly query `classes.class_teacher_id = user.id`
  ...
  return <CommentsClient classes={designatedClasses} terms={terms} />;
}
